...
class ApiConfig:
    ...
    api_base = 'http://xui.xvectorlabs.com:5000/xserver'
    api_version = "api"
    ...
    @staticmethod
    def get_headers():
        # print(ApiConfig.api_header, ApiConfig.api_key)
        # print(ApiConfig.auth_header, ApiConfig.auth_token)
    ...
    @staticmethod
    def get_url():
        # print(ApiConfig.api_version, ApiConfig.url)
